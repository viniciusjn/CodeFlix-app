        ...
        <form onSubmit={onSubmit} className="flex w-full max-w-md rounded flex-col space-y-4 bg-[#141414] bg-opacity-90 px-4 py-8 shadow-lg">
            <div className="flex flex-col items-center space-y-4">
                ...
                <p className="text-sm text-gray-500">
                    ...
                    '/register' :
                    '/login'} className="text-red-500 hover:underline">
                        {formType === 'login' ?
                        'Register' :
                        'Login'}
                    </a>
            ...
            <div className="mt-8 flex flex-col space-y-4">
                <InputField id="email" type="email" label="Email" placeholder="Enter your email"/>
                <InputField id="password" type="password" label="Password" placeholder="Enter your password"/>

                {formType === 'register' &&
                <InputField id="confirmPassword" type="password" label="Confirm Password" placeholder="Confirm your password"/>}
            </div>
